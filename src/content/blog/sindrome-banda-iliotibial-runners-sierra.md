...
excerpt: "La 'rodilla del corredor' es la lesión más frecuente en trail runners de la Sierra de Guadarrama. Causas, tratamiento y vuelta progresiva."
date: 2026-05-15
category: "Deporte"
...
1. **Aumento súbito de kilometraje**: regla del 10% (no aumentes más del 10% semana a semana).
2. **Bajadas técnicas sin estar preparado**: el descenso es más exigente que la subida para la banda.
3. **No trabajar el CORE y los glúteos**: la inestabilidad lateral de pelvis multiplica el problema.
4. **Correr todos los entrenamientos a la misma intensidad**: la falta de variabilidad sobrecarga las mismas estructuras.
5. **No descansar lo suficiente**: el tejido necesita 24-48h entre cargas importantes para recuperarse.

## Tratamiento osteopático + masaje deportivo

Cuando un runner llega con esta lesión, la sesión incluye:

1. **Valoración global**: pisada, postura, movilidad de cadera, fuerza de glúteo medio.
2. **Tratamiento manual del tensor de la fascia lata**: el músculo de origen de la banda. Suele estar muy contracturado.
3. **Liberación de toda la cadena lateral**: cuadrado lumbar, glúteo medio, vasto externo, peroneos.
4. **Trabajo del psoas y movilidad de cadera**: muchas veces la verdadera causa.
